			...
			try {
				...
				const I18N = {
					"zh-CN": {
						...
						fQuality: "画质", fHoleOpacity: "黑洞不透明度", fSkyOpacity: "星空背景不透明度", fSky: "星空背景", fLang: "语言", fPresetLook: "吸积盘外观", fMode: "模式", wallClock: "墙钟",
					...
					"zh-TW": {
						...
						fQuality: "畫質", fHoleOpacity: "黑洞不透明度", fSkyOpacity: "星空背景不透明度", fSky: "星空背景", fLang: "語言", fPresetLook: "吸積盤外觀", fMode: "模式", wallClock: "牆鐘",
					...
					"ja": {
						...
						fQuality: "品質", fHoleOpacity: "ブラックホールの不透明度", fSkyOpacity: "星空背景の不透明度", fSky: "星空背景", fLang: "言語", fPresetLook: "降着円盤の外観", fMode: "モード", wallClock: "時計",
					...
					"en": {
						...
						fQuality: "Quality", fHoleOpacity: "Hole opacity", fSkyOpacity: "Sky opacity", fSky: "Sky background", fLang: "Language", fPresetLook: "Disk look", fMode: "Mode", wallClock: "wall clock",
...
`;
			const UNIFORM_NAMES = [
				...
				"uHoleOpacity", "uSkyOpacity", "uSky", "uSteps",
			];
