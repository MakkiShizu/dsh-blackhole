			...
			function SettingsPage(props) {
				...
				return h("div", { style: S.page },
					...
					group("Background", [
						...
						h("p", { style: S.note }, "Off (default): the hole floats over the page — shadow, photon ring and accretion disk only, everything around is transparent. On: the lensed procedural starfield disc (the original Ghostty-style look) returns."),
					]),
					group("Render", [
