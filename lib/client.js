			...
			try {
				...
				const I18N = {
					"zh-CN": {
						...
						gDrive: "驱动", gPreset: "预设", gSize: "尺寸与运动", gDisk: "吸积盘", gBg: "背景", gRender: "渲染",
						...
						fQuality: "画质", fMaster: "不透明度", fSky: "星空背景", fLang: "语言", fPresetLook: "吸积盘外观", fMode: "模式", wallClock: "墙钟",
					...
					"zh-TW": {
						...
						gDrive: "驅動", gPreset: "預設", gSize: "尺寸與運動", gDisk: "吸積盤", gBg: "背景", gRender: "渲染",
						...
						fQuality: "畫質", fMaster: "不透明度", fSky: "星空背景", fLang: "語言", fPresetLook: "吸積盤外觀", fMode: "模式", wallClock: "牆鐘",
					...
					"ja": {
						...
						gDrive: "駆動", gPreset: "プリセット", gSize: "サイズと動き", gDisk: "降着円盤", gBg: "背景", gRender: "レンダリング",
						...
						fQuality: "品質", fMaster: "不透明度", fSky: "星空背景", fLang: "言語", fPresetLook: "降着円盤の外観", fMode: "モード", wallClock: "時計",
					...
					"en": {
						...
						gDrive: "Drive", gPreset: "Preset", gSize: "Size & motion", gDisk: "Disk", gBg: "Background", gRender: "Render",
						...
						fQuality: "Quality", fMaster: "Opacity", fSky: "Sky background", fLang: "Language", fPresetLook: "Disk look", fMode: "Mode", wallClock: "wall clock",
			...
			function SettingsPage(props) {
				...
				return h("div", { style: S.page },
					...
					group(L.gRender, [
						...
						slider("masterOpacity", L.fMaster, 0, 1, 0.05, pct),
